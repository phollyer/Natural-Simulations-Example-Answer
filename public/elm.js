...
{
	if (region.bt.ax === region.bK.ax)
	{
		return 'on line ' + region.bt.ax;
	}
	return 'on lines ' + region.bt.ax + ' through ' + region.bK.ax;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dJ: 'hidden', dg: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dJ: 'mozHidden', dg: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dJ: 'msHidden', dg: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dJ: 'webkitHidden', dg: 'webkitvisibilitychange' }
		: { dJ: 'hidden', dg: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bN: fragment, bS: host, cp: path, cr: port_, cu: protocol, cv: query};
	});
...
var $author$project$Main$BasicWalkerAnim = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$BasicWalkerMsg = function (a) {
	return {$: 1, a: a};
};
var $author$project$RandomWalks$Basic2$defaultPosition = _Utils_Tuple2(300, 300);
var $author$project$RandomWalks$Basic2$Down = 1;
var $author$project$RandomWalks$Basic2$Left = 2;
var $author$project$RandomWalks$Basic2$NewStep = function (a) {
	return {$: 1, a: a};
};
var $author$project$RandomWalks$Basic2$Right = 3;
var $author$project$RandomWalks$Basic2$Up = 0;
...
var $author$project$RandomWalks$Basic2$stepCmd = A2(
	$elm$random$Random$generate,
	$author$project$RandomWalks$Basic2$NewStep,
	A2(
		$elm$random$Random$uniform,
		0,
		_List_fromArray(
			[1, 2, 3])));
var $author$project$RandomWalks$Basic2$init = _Utils_Tuple2(
	{
		ep: _List_fromArray(
			[$author$project$RandomWalks$Basic2$defaultPosition])
	},
	$author$project$RandomWalks$Basic2$stepCmd);
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Main$init = function (_v0) {
	var _v1 = $author$project$RandomWalks$Basic2$init;
	var subModel = _v1.a;
	var subCmd = _v1.b;
	return _Utils_Tuple2(
		$author$project$Main$BasicWalkerAnim(subModel),
		A2($elm$core$Platform$Cmd$map, $author$project$Main$BasicWalkerMsg, subCmd));
};
var $author$project$Main$BouncingBallMsg = function (a) {
	return {$: 2, a: a};
};
var $elm$core$Platform$Sub$map = _Platform_map;
var $author$project$RandomWalks$Basic2$GetStep = function (a) {
	return {$: 0, a: a};
};
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {ct: processes, cC: taggers};
	});
...
var $author$project$RandomWalks$Basic2$subscriptions = A2($elm$time$Time$every, 10, $author$project$RandomWalks$Basic2$GetStep);
var $author$project$Vector$BouncingBall2$Move = $elm$core$Basics$identity;
var $author$project$Vector$BouncingBall2$subscriptions = A2($elm$time$Time$every, 10, $elm$core$Basics$identity);
var $author$project$Main$subscriptions = function (anim) {
	if (!anim.$) {
		return A2($elm$core$Platform$Sub$map, $author$project$Main$BasicWalkerMsg, $author$project$RandomWalks$Basic2$subscriptions);
	} else {
		return A2($elm$core$Platform$Sub$map, $author$project$Main$BouncingBallMsg, $author$project$Vector$BouncingBall2$subscriptions);
	}
};
var $author$project$Main$BouncingBallAnim = function (a) {
	return {$: 1, a: a};
};
var $author$project$Vector$BouncingBall2$defaultPosition = _Utils_Tuple2(300, 300);
var $author$project$Vector$BouncingBall2$init = {c1: 20, eo: $author$project$Vector$BouncingBall2$defaultPosition, a0: 3, a1: -1};
...
var $author$project$RandomWalks$Basic2$update = F2(
	function (msg, model) {
		if (!msg.$) {
			return _Utils_Tuple2(model, $author$project$RandomWalks$Basic2$stepCmd);
		} else {
			var step = msg.a;
			var delta = 6;
			var _v1 = A2(
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						ep: A2($elm$core$List$cons, newPosition, model.ep)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $elm$core$Basics$ge = _Utils_ge;
var $author$project$Vector$BouncingBall2$height = 600;
var $author$project$Vector$BouncingBall2$width = 600;
var $author$project$Vector$BouncingBall2$update = F2(
	function (msg, model) {
		var ySpeed = model.a1;
		var xSpeed = model.a0;
		var r = model.c1;
		...
		var y = _v0.b;
		var newX = x + xSpeed;
		var newXSpeed = ((_Utils_cmp(newX, r) < 1) || (_Utils_cmp(newX, $author$project$Vector$BouncingBall2$width - r) > -1)) ? ((-1) * xSpeed) : xSpeed;
		var newY = y + ySpeed;
		var newYSpeed = ((_Utils_cmp(newY, r) < 1) || (_Utils_cmp(newY, $author$project$Vector$BouncingBall2$height - r) > -1)) ? ((-1) * ySpeed) : ySpeed;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					eo: _Utils_Tuple2(newX, newY),
					a0: newXSpeed,
					a1: newYSpeed
				}),
			$elm$core$Platform$Cmd$none);
		...
		while (true) {
			switch (_v0.a.$) {
				case 0:
					var anim = _v0.a.a;
					if (!anim) {
						var _v2 = $author$project$RandomWalks$Basic2$init;
						var subModel = _v2.a;
						var subCmd = _v2.b;
						return _Utils_Tuple2(
							$author$project$Main$BasicWalkerAnim(subModel),
						...
						return _Utils_Tuple2(
							$author$project$Main$BouncingBallAnim($author$project$Vector$BouncingBall2$init),
							$elm$core$Platform$Cmd$none);
					}
				case 1:
					if (!_v0.b.$) {
						...
						var _v3 = A2($author$project$RandomWalks$Basic2$update, subMsg, subModel);
						var newSubModel = _v3.a;
						var subCmd = _v3.b;
						return _Utils_Tuple2(
							$author$project$Main$BasicWalkerAnim(newSubModel),
							A2($elm$core$Platform$Cmd$map, $author$project$Main$BasicWalkerMsg, subCmd));
					} else {
						break _v0$3;
					}
				default:
					if (_v0.b.$ === 1) {
						var subMsg = _v0.a.a;
						var subModel = _v0.b.a;
						var _v4 = A2($author$project$Vector$BouncingBall2$update, subMsg, subModel);
						var newSubModel = _v4.a;
						var subCmd = _v4.b;
						return _Utils_Tuple2(
							$author$project$Main$BouncingBallAnim(newSubModel),
							A2($elm$core$Platform$Cmd$map, $author$project$Main$BouncingBallMsg, subCmd));
					} else {
						break _v0$3;
					}
			}
...
var $author$project$Main$BasicWalker = 0;
var $author$project$Main$BouncingBall = 1;
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {cO: 'a', a3: 'atv', cQ: 'ab', cR: 'cx', cS: 'cy', cT: 'acb', cU: 'accx', cV: 'accy', cW: 'acr', bC: 'al', bD: 'ar', cX: 'at', a4: 'ah', a5: 'av', c_: 's', c3: 'bh', c4: 'b', c7: 'w7', c9: 'bd', da: 'bdt', aG: 'bn', db: 'bs', aH: 'cpe', dk: 'cp', dl: 'cpx', dm: 'cpy', M: 'c', aJ: 'ctr', aK: 'cb', aL: 'ccx', N: 'ccy', av: 'cl', aM: 'cr', dp: 'ct', dr: 'cptr', ds: 'ctxt', dF: 'fcs', bM: 'focus-within', dG: 'fs', dH: 'g', bh: 'hbh', bi: 'hc', bQ: 'he', bj: 'hf', bR: 'hfp', dK: 'hv', dO: 'ic', dQ: 'fr', dS: 'iml', dT: 'imlf', dU: 'imlp', dV: 'implw', dW: 'it', dY: 'i', bY: 'lnk', am: 'nb', cg: 'notxt', ea: 'ol', ed: 'or', _: 'oq', eh: 'oh', cn: 'pg', co: 'p', ek: 'ppe', es: 'ui', A: 'r', ev: 'sb', ew: 'sbx', ex: 'sby', ey: 'sbt', eA: 'e', eB: 'cap', eC: 'sev', eI: 'sk', v: 't', eM: 'tc', eN: 'w8', eO: 'w2', eP: 'w9', eQ: 'tj', aX: 'tja', eR: 'tl', eS: 'w3', eT: 'w5', eU: 'w4', eV: 'tr', eW: 'w6', eX: 'w1', eY: 'tun', cD: 'ts', ae: 'clr', e4: 'u', by: 'wc', cJ: 'we', bz: 'wf', cK: 'wfp', bA: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$Generic = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$div = $mdgriffith$elm_ui$Internal$Model$Generic;
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.c_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.M);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.c_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dH);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.c_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cn);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.c_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.co);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.c_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.A);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.c_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eA);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.D)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.eD.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.eD.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.A) + ('-' + ($elm$core$String$fromInt(pos.dn) + ('-' + ($elm$core$String$fromInt(pos.cI) + ('-' + $elm$core$String$fromInt(pos.bP)))))));
		case 11:
	...
	[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dK, $mdgriffith$elm_ui$Internal$Style$classes._)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dF, $mdgriffith$elm_ui$Internal$Style$classes._)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.a3, $mdgriffith$elm_ui$Internal$Style$classes._)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c_) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.A) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c_) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c_) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.A) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c_) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aJ) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aI: closing, l: _List_Nil, R: _List_Nil, I: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								l: A2(
									$elm$core$List$cons,
									{aI: '\n}', l: _List_Nil, R: props, I: '@supports (' + (prop + (':' + (value + (') {' + parent.I))))},
									rendered.l)
							});
					case 4:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.I + ('{' + (renderValues(rule.R) + (rule.aI + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.A) + (' / ' + ($elm$core$String$fromInt(position.A + position.bP) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.dn) + (' / ' + ($elm$core$String$fromInt(position.dn + position.cI) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.A) + ('-' + ($elm$core$String$fromInt(position.dn) + ('-' + ($elm$core$String$fromInt(position.cI) + ('-' + $elm$core$String$fromInt(position.bP)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.eB + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.v + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.eB + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.v)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bP: height / size, ap: size, cF: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.df, adjustment.c2, adjustment.dx, adjustment.d$]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.c_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eA))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c_, $mdgriffith$elm_ui$Internal$Style$classes.eA, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.N, $mdgriffith$elm_ui$Internal$Style$classes.cW])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c_, $mdgriffith$elm_ui$Internal$Style$classes.eA, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.N, $mdgriffith$elm_ui$Internal$Style$classes.cU])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c_, $mdgriffith$elm_ui$Internal$Style$classes.eA, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.cV])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c_, $mdgriffith$elm_ui$Internal$Style$classes.eA, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.cT])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.c_ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.v + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.by + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bi)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.c_ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.v + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bz + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bj)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.am, $mdgriffith$elm_ui$Internal$Style$classes.eA, $mdgriffith$elm_ui$Internal$Style$classes.cO]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.am, $mdgriffith$elm_ui$Internal$Style$classes.eA, $mdgriffith$elm_ui$Internal$Style$classes.c4]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.am, $mdgriffith$elm_ui$Internal$Style$classes.eA, $mdgriffith$elm_ui$Internal$Style$classes.ed]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.am, $mdgriffith$elm_ui$Internal$Style$classes.eA, $mdgriffith$elm_ui$Internal$Style$classes.ea]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
							...
							default:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.am, $mdgriffith$elm_ui$Internal$Style$classes.eA, $mdgriffith$elm_ui$Internal$Style$classes.c3]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.a4 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bC);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.a4 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bD);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.a4 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cR);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.a5 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cX);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.a5 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cQ);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.a5 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cS);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.c_ + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.M + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.c_ + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.A + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.dp + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.av)),
				A2(
					$elm$core$List$cons,
...
var $author$project$RandomWalks$Basic2$point = function (position) {
	var _v0 = position;
	var x = _v0.a;
	var y = _v0.b;
	return A2(
...
var $author$project$RandomWalks$Basic2$view = function (positions) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$RandomWalks$Basic2$point, positions));
};
var $author$project$Vector$BouncingBall2$view = F2(
			...
			[
				...
				if (!model.$) {
					...
					return A2(
						...
						$author$project$RandomWalks$Basic2$view(subModel.ep));
				} else {
					var subModel = model.a;
					return A2(
						$elm$html$Html$map,
						$author$project$Main$BouncingBallMsg,
						A2($author$project$Vector$BouncingBall2$view, subModel.c1, subModel.eo));
				}
			}()
			]));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.es, $mdgriffith$elm_ui$Internal$Style$classes.c_, $mdgriffith$elm_ui$Internal$Style$classes.eA]))),
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text('Bouncing Ball'))
						]))
				])));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{dR: $author$project$Main$init, eK: $author$project$Main$subscriptions, e5: $author$project$Main$update, e6: $author$project$Main$view});
